...
<pre class="brush: csharp;">var posts = Builder&lt;Post&gt;.CreateListOfSize(10)
                .WhereAll()
...
<pre class="brush: csharp;">//Definisco il servizio di persistenza da invocare
BuilderSetup.SetCreatePeristenceMethod&lt;Post&gt; (postService.SaveOrUpdate);

//Persisto l'oggetto fake
Builder&lt;Post&gt;.CreateNew().Persist();</pre>
